...
public final class Vector implements Comparable<Vector>
{
    ...
    public String toString() {
        return String.format("Direction: %d; Length: %.1f", direction, length);
    }
    ...
    public boolean equals(Object o) {
        ...
        Vector v = (Vector) o;
        if ((v.direction == this.direction) && (Math.abs(v.length - this.length) < 0.001)) {
            return true;
        }
        else {
            return false;
    ...
    public int compareTo(Vector v) {
        int d = this.direction - v.direction;
