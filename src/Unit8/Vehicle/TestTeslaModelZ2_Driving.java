...
public class TestTeslaModelZ2_Driving extends BCATestScenario {
	...
	public int runTest() {
		...
		car2.drive(30);
		assertEquals(car2.getMileage(), 30, 0.1, "Mileage should be 30.");
		car2.drive(200);
		assertEquals(car2.getMileage(), 230, 0.1, "Mileage should be 230.");
		assertEquals(car2.getRemainingRange(), 110, 0.1, "Remaining range should be 110.");
		...
		car2.drive(105);
		assertEquals(car2.getMileage(), 335, 0.1, "Mileage should be 335.");
		...
		car2.recharge();
		assertEquals(car2.getRemainingRange() / car2.getMaxRange() * 100, car2.getMaxRange() / car2.getMaxRange() * 100, 0.1, "Charge should be 100 after recharging.");
