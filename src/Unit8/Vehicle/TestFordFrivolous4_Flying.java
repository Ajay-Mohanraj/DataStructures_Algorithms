...
public class TestFordFrivolous4_Flying extends BCATestScenario {
	...
	public int runTest() {
		...
		f3.fly(157.333);
		assertEquals(f3.getMileage(), 0, DELTA, "Flying should not increase mileage.");
		assertEquals(f3.getRemainingRange(), 0, DELTA, "There should be no miles left to fly or drive.");
		assertEquals(f3.getFuelLevel(), 0, DELTA, "The tank should be empty.");
